...
import 'package:msa_internship/presentation/resources/font_manager.dart';
import 'package:msa_internship/presentation/resources/string_manager.dart';
import 'package:msa_internship/presentation/resources/style_manager.dart';
import 'package:msa_internship/presentation/resources/values_manager.dart';
    ...
    switch (stateRendererType) {
      ...
      case StateRendererType.FULL_SCREEN_ERROR_STATE:
        return _getItemsInColumn([
          _getAnimatedImage(JsonAssets.error),
          _getMessage(failure.message),
          _getRetryButton(StringManager.retry_again, context)
        ]);
